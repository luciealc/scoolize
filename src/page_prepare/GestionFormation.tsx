        ...
        <div>
            <MainContentPage>
                <div className='container mx-auto p-4'>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-2 gap-2 overflow-y-auto max-h-[650px]">
                        <ModificationFormationPage onButtonClick={openModal} />
                        <ModificationFormationPage onButtonClick={openModal} />
                        <ModificationFormationPage onButtonClick={openModal} />
                        <ModificationFormationPage onButtonClick={openModal} />
                        <ModificationFormationPage onButtonClick={openModal} />
            ...
            {isModalOpen && (
                <FormationPopUpPage onClose={closeModal}>
                    <div>
